...
public class Atividade implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (idAtividade == null) {
			if (other.getIdAtividade() != null)
				return false;
		} else if (!idAtividade.equals(other.getIdAtividade()))
			return false;
		return true;
	}
	...
	public String toString() {
		return "Atividade [idAtividade=" + idAtividade + ", usuarioIdUsuario=" + usuarioIdUsuario + ", nome=" + nome
